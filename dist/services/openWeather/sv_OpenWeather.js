...
var OpenWeather = /** @class */ (function () {
    ...
    OpenWeather.prototype.getKey = function () {
        this.key = process.env.TelegramBot_Ukranian_OpenWeatherKey;
    };
    OpenWeather.prototype.getWeather = function (city) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get(this.weatherUrl + "/?q=" + city + "&appid=" + this.key + "&units=metric").then(function (r) {
                                return {
                                    status: r.status,
                                    city: r.data.name,
